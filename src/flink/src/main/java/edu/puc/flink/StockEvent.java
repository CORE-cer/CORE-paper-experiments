...
public class StockEvent extends Event {
    ...
    public StockEvent(String type, String name, int id, int volume, double price, int stock_time){
        super(type, id);
        this.type = type;
        this.id = id;
        this.name = name;
    ...
    static public StockEvent getEventFromString(String data) {
        StockEvent toReturn = new StockEvent();
        int offset = 0;
